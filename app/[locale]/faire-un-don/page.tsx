        ...
        <>
            <div className=" w-full bg-purple-900 text-white text-center py-2 z-50">
                ...
                <span className="font-bold lowercase">
                    {donors[currentIndex].name}
                </span>{" "}
                pour son don de{" "}
                <span className="font-bold">
                    {donors[currentIndex].amount} FCFA
                </span>
            </div>
                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 mb-10 gap-6 w-full max-w-6xl">
                    ...
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div className="p-4 space-y-4">
                            ...
                            <button className="w-full bg-orange-500 text-white py-4 rounded font-bold text-lg hover:bg-orange-400 transition">
                                JE VALIDE MON DON DE {selectedAmount} €
                            </button>
